...
const aboutSchema = {
  ...
  '@type': 'WebPage',
  name: 'About Energosoyuz | Global Petroleum Mandate | Kazakhstan',
  description: 'Energosoyuz Tsentralnaja Azija LLP — founded 2004, headquartered in Aktobe, Kazakhstan. Two decades of energy trading, now a verified global petroleum mandate.',
  url: 'https://www.energosoyuz.com/about',
};
...
export default function AboutPage() {
  ...
  return (
    <>
      <SEOHead
        title="About Energosoyuz | Global Petroleum Mandate | Kazakhstan"
        description="Energosoyuz Tsentralnaja Azija LLP — founded 2004 in Aktobe, Kazakhstan. ISO 9001 & OHSAS 18001 certified petroleum trading company and verified global oil mandate."
        canonical="https://www.energosoyuz.com/about"
        jsonLd={aboutSchema}
      />
      ...
      <div style={{ background: `linear-gradient(135deg, #0a0a0a 0%, ${TEAL} 100%)`, padding: '80px 24px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          >
            Two decades of excellence in energy trading, supply, and distribution — from Central Asia to global petroleum markets.
          </motion.p>
        </div>
      </div>
          ...
          <FadeIn direction="left">
            <div>
              ...
              <p style={{ fontFamily: "'Barlow', sans-serif", fontSize: '0.95rem', color: '#1a1a1a', marginTop: '8px' }}>
                Join our growing network of energy partners across Central Asia and beyond.
              </p>
            </div>
          </FadeIn>
          <motion.button
