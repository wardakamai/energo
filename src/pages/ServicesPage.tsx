...
const servicesSchema = {
  ...
  '@type': 'WebPage',
  name: 'Petroleum Services — Trading, Storage & Supply | Energosoyuz',
  description: 'Energosoyuz provides petroleum trading, bulk supply, and storage services at Rotterdam, Houston, Fujairah, and Jurong. Quality management and full documentation.',
  url: 'https://www.energosoyuz.com/services',
};
...
const services = [
  {
    ...
    desc: 'We specialise in the trading and supply of certified petroleum products — EN590 diesel, Jet A1 aviation fuel, and Virgin Fuel Oil D6. Operating as a direct mandate, buyers transact with the principal with no broker intermediaries.',
    features: ['EN590 Ultra-Low Sulfur Diesel', 'Jet A1 Aviation Turbine Fuel', 'Virgin Fuel Oil / D6', 'Verified mandate — direct principal'],
    icon: (
  ...
  },
  {
    ...
    desc: 'Our global supply network supports large-volume petroleum mandates with competitive CIF, FOB, and DAP delivery terms. We coordinate documentation, inspection, and delivery from point of storage to final destination.',
    features: ['CIF Rotterdam delivery', 'FOB loading options', 'Full documentation package', 'Third-party inspection (SGS/Intertek)'],
    icon: (
      <svg viewBox="0 0 80 80" fill="none" width="64" height="64">
  ...
  },
  {
    ...
    subtitle: 'Port Infrastructure',
    desc: 'Energosoyuz holds confirmed petroleum storage at four strategically located ports: Rotterdam (Netherlands), Houston (United States), Fujairah (UAE), and Jurong (Singapore). These locations cover Europe, the Americas, the Middle East, and Asia-Pacific.',
    features: ['Rotterdam — Europe\'s largest petroleum hub', 'Houston — US Gulf Coast refining complex', 'Fujairah — Middle East bunkering hub', 'Jurong — Asia-Pacific petroleum gateway'],
    portLinks: true,
    icon: (
      <svg viewBox="0 0 80 80" fill="none" width="64" height="64">
  ...
  },
  {
    ...
    desc: 'Rigorous quality control processes and health, safety, and environmental management systems ensure our operations meet the highest international standards. All products are supplied with full certificates of quality.',
  ...
  },
  {
    ...
    desc: 'Expert advisory services to help businesses optimise their energy procurement and supply strategy. Our consultants bring decades of experience in petroleum trading and Central Asian energy markets.',
...
const portLinks = [
  { name: 'Rotterdam', path: '/ports/rotterdam' },
  { name: 'Houston', path: '/ports/houston' },
  { name: 'Fujairah', path: '/ports/fujairah' },
  { name: 'Jurong', path: '/ports/jurong' },
];
...
export default function ServicesPage() {
  ...
  return (
    <>
      <SEOHead
        title="Petroleum Services — Trading, Storage & Supply | Energosoyuz"
        description="Energosoyuz provides bulk petroleum supply, storage at Rotterdam, Houston, Fujairah and Jurong, and quality-certified delivery for EN590, Jet A1 and VFO D6 mandates."
        canonical="https://www.energosoyuz.com/services"
      ...
      <div style={{ background: `linear-gradient(135deg, #0a0a0a 0%, ${TEAL} 100%)`, padding: '80px 24px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <motion.p initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.6, delay: 0.4 }}
            ...
            From petroleum trading and bulk supply to global port storage and quality management — comprehensive energy services for buyers and mandates worldwide.
          </motion.p>
        </div>
      </div>
            ...
            {services.map((svc, i) => (
              <FadeIn key={i} delay={0.05}>
                <motion.div
                  ...
                  style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', background: i % 2 === 0 ? '#fff' : '#f9f9f9', border: '1px solid #eee', overflow: 'hidden' }}
                  className="service-row"
                >
                  {/* Left: dark panel */}
                  <div style={{ background: `linear-gradient(135deg, #0a0a0a 0%, ${TEAL}cc 100%)`, padding: '48px', display: 'flex', flexDirection: 'column', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
                      ...
                      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', marginTop: '24px' }}>
                        {portLinks.map(p => (
                          <Link key={p.path} to={p.path}
                            style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', padding: '6px 14px', border: `1px solid ${AMBER}44`, color: AMBER, fontFamily: "'Barlow', sans-serif", fontWeight: 600, fontSize: '0.75rem', letterSpacing: '0.06em', textDecoration: 'none', textTransform: 'uppercase', transition: 'all 0.2s' }}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '40px', alignItems: 'center' }}>
            <FadeIn>
              ...
              <p style={{ fontFamily: "'Barlow', sans-serif", fontSize: '0.95rem', lineHeight: 1.8, color: '#1a1a1a' }}>
                Founded in 2004 and headquartered in Aktobe, Kazakhstan, Energosoyuz brings over two decades of energy trading experience and a global storage network serving buyers across every major petroleum market.
              </p>
            </FadeIn>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              {[
                { icon: '⚡', label: '20+ Years Experience' },
                { icon: '🌍', label: '4 Global Storage Hubs' },
                { icon: '🏭', label: 'Verified Mandate' },
                { icon: '🤝', label: 'Direct Principal' },
              ].map((item, i) => (
                <motion.div key={i}
      ...
      <section style={{ background: `linear-gradient(135deg, #0a0a0a 0%, ${TEAL} 100%)`, padding: '80px 24px' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', textAlign: 'center' }}>
          <FadeIn>
            ...
            <p style={{ fontFamily: "'Barlow', sans-serif", fontSize: '0.95rem', color: '#aaa', margin: '16px auto 40px', maxWidth: '480px', lineHeight: 1.7 }}>
              Our team is ready to discuss your petroleum supply requirements, delivery terms, and logistics.
            </p>
