...
const contactSchema = {
  ...
  '@type': 'ContactPage',
  name: 'Contact Energosoyuz | Petroleum Supply Enquiries',
  description: 'Contact Energosoyuz for EN590 diesel, Jet A1, and VFO D6 supply enquiries. Headquarters in Aktobe, Kazakhstan. Respond within 24 hours.',
  url: 'https://www.energosoyuz.com/contact',
};
...
export default function ContactPage() {
  ...
  return (
    <>
      <SEOHead
        title="Contact Energosoyuz | Petroleum Supply Enquiries"
        description="Contact Energosoyuz for EN590 diesel, Jet A1 aviation fuel, and VFO D6 supply enquiries. Storage at Rotterdam, Houston, Fujairah, Jurong. Reply within 24 hours."
        canonical="https://www.energosoyuz.com/contact"
      ...
      <div style={{ background: `linear-gradient(135deg, #0a0a0a 0%, ${TEAL} 100%)`, padding: '80px 24px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <motion.p initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.6, delay: 0.4 }}
            ...
            Ready to discuss your petroleum supply needs? Our team responds within 24 hours. Reach out about EN590, Jet A1, VFO D6, or storage at any of our four global hubs.
          </motion.p>
        </div>
      </div>
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginTop: '24px' }}>
                  ...
                  <div>
                    ...
                    <select className="form-input" name="subject" value={form.subject} onChange={handleChange} required>
                      ...
                      <optgroup label="Product Enquiries">
                        <option>EN590 Diesel Fuel</option>
                        <option>Jet A1 Aviation Fuel</option>
                        <option>Virgin Fuel Oil / D6</option>
                      </optgroup>
                      <optgroup label="Storage Locations">
                        <option>Rotterdam Supply (Netherlands)</option>
                        <option>Houston Supply (United States)</option>
                        <option>Fujairah Supply (UAE)</option>
                        <option>Jurong Supply (Singapore)</option>
                      </optgroup>
                  ...
                  <div>
                    ...
                    <textarea className="form-input" name="message" value={form.message} onChange={handleChange} placeholder="Tell us about your petroleum supply needs..." rows={5} required style={{ resize: 'vertical', minHeight: '120px' }} />
                  </div>
